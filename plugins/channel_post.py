...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start', 'users', 'broadcast', 'batch', 'genlink', 'stats', 'count', 'total', 'puser', 'removepremium', 'premiumlist']))
